...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // this is some garbage to test the rgb lights
/*
	KEYMAP(
		RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, 
		RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, 
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_ENT, 
		BL_TOGG, KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
*/
	KEYMAP(
//,-----------------------------------------------------------------------------------------------------------.
...
//|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_ENT, 
//|--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
    BL_TOGG, KC_LCTL, KC_LALT, KC_LGUI,   MO(1),  KC_SPC,   MO(2), KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT,  KC_NO),
//,-----------------------------------------------------------------------------------------------------------.
